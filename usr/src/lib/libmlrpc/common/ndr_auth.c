...
ndr_add_sec_context(ndr_auth_ctx_t *ctx, ndr_xa_t *mxa)
{
	...
	return (ctx->auth_ops.init(ctx->auth_ctx, mxa));
}
...
ndr_recv_sec_context(ndr_auth_ctx_t *ctx, ndr_xa_t *mxa)
{
	...
	return (ctx->auth_ops.recv(ctx->auth_ctx, mxa));
}
...
ndr_add_auth(ndr_auth_ctx_t *ctx, ndr_xa_t *mxa)
{
	...
	return (ctx->auth_ops.sign(ctx->auth_ctx, mxa));
}
 ...
 *
 * If auth_verify_resp is B_FALSE, this doesn't verify respones (but
...
ndr_check_auth(ndr_auth_ctx_t *ctx, ndr_xa_t *mxa)
{
	...
	return (ctx->auth_ops.verify(ctx->auth_ctx, mxa,
